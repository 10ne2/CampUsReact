...
const FbCard = styled(Card)`background:#f9fafb;border-color:#e5e7eb;`;
    ...
    <MobileShell>
      <div style={{ backgroundColor: "#fff", padding: "1px 20px 24px" }}>
        <Container style={{backgroundColor:"#fff", display:"flex", justifyContent:"space-between"}}>
          <img src={Cancle} alt="닫기" style={{width:"19px", height:"19px", cursor:"pointer"}} onClick={() => navigate(-1)} />
        </Container>
        <MintDivider />
        ...
        <Card>
          ...
          <CardHr />
          <CardFooterRight>
            <GhostBtn onClick={() => navigate(-1)}>목록</GhostBtn>
          </CardFooterRight>
        </Card>
      </div>
