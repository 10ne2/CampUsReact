            ...
            <ListHeader style={{height:'97px', padding:'13px 25px'}}>
                ...
                <FlexDiv style={{marginTop:'10px'}}>
                    ...
                    <FlexDiv style={{width:'340px', justifyContent:'end', marginTop:'-2px'}}>
                        <Button style={{marginLeft:'0', backgroundColor:'#fff', border:'1px solid #aaa', color:'#aaa', width:'50px'}}>복구</Button>
                        <Button style={{marginLeft:'10px', backgroundColor:'#fff', border:'1px solid #aaa', color:'#aaa', width:'60px'}}>영구삭제</Button>
                    </FlexDiv>
                </FlexDiv>
            </ListHeader>
            <WHContainer>
                <div>
                    ...
                    <Title style={{width:'200px', marginLeft:'27px', marginTop:'-3px', fontWeight:'400'}}>과제 질문 있습니다~</Title>
                </div>
                <div style={{marginLeft:'auto', marginTop:'-2px'}}>
                    <DateBox>25-08-21</DateBox>
                    <DateBox style={{marginTop:'5px'}}>[받은메일]</DateBox>
                </div>
            </WHContainer>
            <nav>
                <PageNation>
